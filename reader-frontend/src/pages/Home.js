    ...
    return(
        <div className="home">
            <div>
                ...
                <a href="https://github.com/mickywagner/blog_rest_api" target="_blank">Check out the code on Github < GrGithub /></a>
                <Link to="/blog">Go to Blog <FiArrowRightCircle /> </Link>
            </div>  
        </div>
